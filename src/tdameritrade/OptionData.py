...
from src.Utils import ms_to_datetime, datetime_to_str
        ...
        if self.oi > 0:
            ...
            if self.volatility > 0.0:
                ...
                if self.daysToExpiration > 1:
                    ...
                    self.intrinsicValue = float(jsondata['intrinsicValue'])

                    self.premium = 0.0
                    if self.intrinsicValue > 0.0:
                        self.premium = (self.mark - self.intrinsicValue) / self.intrinsicValue * 100.0
